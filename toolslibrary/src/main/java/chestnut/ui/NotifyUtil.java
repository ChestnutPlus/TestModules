...
//        inboxStyle.setSummaryText("[" + messageList.size() + mContext.getText(R.string.messagesizeunit) + "]" + title);
        inboxStyle.setSummaryText("[" + messageList.size() + "s" + "]" + title);
    ...
    public void notify_progress(PendingIntent pendingIntent, int smallIcon,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // 进度满了后，设置提示信息
//                cBuilder.setContentText(mContext.getText(R.string.downloadcomplete)).setProgress(0, 0, false);
