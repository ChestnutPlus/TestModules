...
public class PhoneUtils {
     ...
     * @param stringPath 路径
     */
    public static void saveAllSMSToXML(Context context,String stringPath) {
        saveAllSMSToXML(context,new File(stringPath));
    }
     ...
     * @param file 路径
     */
    public static void saveAllSMSToXML(Context context,File file) {
        // 1.获取短信
        // 1.1获取内容解析者
        ContentResolver resolver = context.getContentResolver();
